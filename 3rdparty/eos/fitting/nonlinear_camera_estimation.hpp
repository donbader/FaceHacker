 ...
 * @endcode
 */
inline glm::mat4x4 get_4x4_modelview_matrix(fitting::RenderingParameters params)
{
 ...
 */
inline cv::Mat get_3x4_affine_camera_matrix(fitting::RenderingParameters params, int width, int height)
{
